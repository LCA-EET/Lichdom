EXTEND_BOTTOM XALDGD 15
	...
	EXTERN X3KalJ XA_LD_ChooseKale1
	...
	~
	THEN REPLY @4 /*@4 = ~(Choose Kale.)~*/
	EXTERN X3KalJ XA_LD_ChooseKale2
	...
	~
	THEN REPLY @4 /*@4 = ~(Choose Kale.)~*/
	EXTERN X3KalJ XA_LD_ChooseKale3
END
...
INTERJECT_COPY_TRANS2 XALDGD 75 XA_LD_X3KalJ_75
	== X3KalJ
	IF ~
		IsValidForPartyDialogue("X3Kal")
	~
...
INTERJECT_COPY_TRANS2 XALDGD 76 XA_LD_X3KalJ_76
	== X3KalJ
	IF ~
		IsValidForPartyDialogue("X3Kal")
	~
...
INTERJECT_COPY_TRANS2 XALDGD 77 XA_LD_X3KalJ_77
	== X3KalJ
	IF ~
		IsValidForPartyDialogue("X3Kal")
	~
